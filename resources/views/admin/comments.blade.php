                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#">
                                                        <img class="media-object rounded-circle" src="{{ Storage::disk('public')->url('profile/'.$comment->user->image) }}" width="64" height="64">
                                                    </a>
                                                </div>
                                        ...
                                        <td>
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <a target="_blank" href="{{ route('post.details',$comment->post->slug.'#comments') }}">View</a>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
